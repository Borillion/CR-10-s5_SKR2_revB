 ...
 *
 * This program is free software: you can redistribute it and/or modifyaa
...
#define STRING_CONFIG_H_AUTHOR "(Babak Rezai, CR-10 S5 with SKR 2 & BLtouch )" // Who made the changes.
